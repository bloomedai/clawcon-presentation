...
- Conventional commits (for PR names, too) with gitmoji: `feat✨ fix🐛 docs📝 style💄 refactor♻️ test✅ chore🔧`
...
2. **Tests first, and they must fail.** Write or update tests before implementation code. Run them and confirm they fail (red). If they pass before implementation, the tests are wrong — fix them.
...
10. **Prefer integration tests over unit tests when cheap.** Especially for glue code — test the real thing instead of mocking everything around it.
